...
public class AsynchronousFileChannelExample {
    ...
    public AsynchronousFileChannelExample() throws IOException {
        ...
        final AsynchronousFileChannel fileChannel = AsynchronousFileChannel.open(Paths.get("afile"), StandardOpenOption.READ, StandardOpenOption.WRITE, StandardOpenOption.CREATE, StandardOpenOption.DELETE_ON_CLOSE);
